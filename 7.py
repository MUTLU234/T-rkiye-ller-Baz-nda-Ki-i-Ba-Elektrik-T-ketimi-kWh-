...
cmap = plt.cm.winter  # veya matplotlib.colors.LinearSegmentedColormap kullanabilirsiniz
...
# Her şehrin üzerine isimlerini yazın (baş harfi büyük)
for idx, row in turkey_map.iterrows():
    city_name = row['name'].capitalize()  # Sadece baş harfi büyük yap
